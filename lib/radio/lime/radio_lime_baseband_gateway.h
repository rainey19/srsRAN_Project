...
class radio_lime_baseband_gateway : public baseband_gateway
{
public:
  radio_lime_baseband_gateway(radio_lime_device&                              device,
                              task_executor&                                  async_executor,
                              radio_notification_handler&                     notifier,
                              const radio_lime_tx_stream::stream_description& tx_stream_config,
                              const radio_lime_rx_stream::stream_description& rx_stream_config) :
  ...
  radio_lime_tx_stream& get_tx_stream() { return *tx_stream; }

  /// Gets the transmit stream.
  radio_lime_rx_stream& get_rx_stream() { return *rx_stream; }
...
private:
  /// Transmit stream.
  std::unique_ptr<radio_lime_tx_stream> tx_stream;
  /// Receive stream.
  std::unique_ptr<radio_lime_rx_stream> rx_stream;
};
